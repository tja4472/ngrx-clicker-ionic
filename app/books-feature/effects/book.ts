 ...
 */
  @Effect() public openDB$: Observable<IDBDatabase> = this.db.open('books_app').filter(() => false);

  @Effect() public loadCollectionOnInit$: Observable<Action> = Observable.of(this.bookActions.loadCollection());
  ...
  @Effect() public removeBookFromCollection$: Observable<Action> = this.updates$
