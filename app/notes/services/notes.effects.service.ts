...
export class NotesEffectsService {
  ...
  @Effect() public add$: any = this.updates$
    .whenAction('ADD_NOTE')
    .do(val => console.log('NotesEffectsService:ADD_NOTE>>>', val))
  ...
  @Effect() public update$: any = this.updates$
  ...
  @Effect() public init$: any = this.updates$
